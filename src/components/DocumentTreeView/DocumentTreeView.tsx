...
const RecommendationsTable: React.FunctionComponent = (props) => {
  const list = _.zip(props.children.fields, props.values) as any;
...
export const DocumentTreeView: React.FunctionComponent = (props) => {
  if (props.document) {
